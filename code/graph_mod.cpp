...
Graph::NodeId Graph::invalid_node = -1;
double Graph::infinite_weight = std::numeric_limits<double>::max();
...
Graph::NodeId Graph::Neighbor::id()
{
   return _id;
}

double Graph::Neighbor::edge_weight()
{
   return _edge_weight;
}
...
Graph::Graph(char* filename, DirType dtype) : dirtype(dtype)
{
